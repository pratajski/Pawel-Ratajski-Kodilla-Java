...
public class ForumTestSuite {
    ...
    public void beforeEveryTest(){
        testCounter++;
        System.out.println("Prepaing to execute test #" + testCounter);
    }
    ...
    public void testAddComment() {
        ...
        //When
        forumUser.addCommment(thePost, "mrsmith", "Thank you for all good words!");
    ...
    public void tetGetComment(){
        ...
        forumUser.addCommment(thePost, theComment.getAuthor(), theComment.getCommentBody());
